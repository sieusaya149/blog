...
CREATE TABLE IF NOT EXISTS COMMENT(
    ...
    FOREIGN KEY (parentCommentId) REFERENCES COMMENT(commendId));
...
CREATE TABLE IF NOT EXISTS SAVELIST_POST(
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (saveListId) REFERENCES SAVELIST(saveListId),
    FOREIGN KEY (postId) REFERENCES POST(postId));
...
CREATE TABLE IF NOT EXISTS VERIFYCODE(
    verifyCode CHAR(36),
    codeVerify VARCHAR(255) UNIQUE NOT NULL,
